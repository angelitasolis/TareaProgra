...
import com.mariangel.administracion_tarea.App;
...
import com.mariangel.administracion_tarea.Controller.Controller;
...
public class FlowController {
    ...
    public void goMain() {
        try {
            this.mainStage.setScene(new Scene(FXMLLoader.load(App.class.getResource("view/PantallaPrincipal.fxml"), this.idioma)));
            this.mainStage.show();
